...
GLfloat materialSpecular[] = { 0.3f, 0.3f, 0.5f, 1.0f };
...
int initialize(void)
{
	...
	// texture loading 
	bResult = loadGLTexture_stb(&texture_Sphere, "Earth.jpg");
	if (bResult == FALSE)
	{
...
void display(void)
{
	...
	mat4 rotationMatrix_sphere2 = vmath::rotate(70 - inc, 0.0f, 0.0f, 1.0f);
